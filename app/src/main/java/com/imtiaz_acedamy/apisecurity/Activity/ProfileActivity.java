...
public class ProfileActivity extends BaseActivity {
    ...
    public static boolean SHARED_PREF = true;
    ...
    private void loadSharePre(){
        if (sharedPreferences != null){
            ...
            String getPhoneNo = sharedPreferences.getString("phoneNo", "default value");
            String getMail = sharedPreferences.getString("mail", "default value");
